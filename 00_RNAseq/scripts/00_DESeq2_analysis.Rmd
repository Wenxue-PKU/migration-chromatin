...
groups <- data.frame(factor(c("m14","m14","m14","m5","m5","m5", "nm","nm","nm")))
rownames(groups) <- colnames(raw_counts)
colnames(groups) <- "condition"
...
plotPCA(vsd, intgroup=c("condition")) + theme_classic() + theme(text = element_text(size = 20))
ggsave("../plots/PCA_5v14vcontrol.pdf")
```
